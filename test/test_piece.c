...
void test_get_piece_label(void)
{
...
void test_piece_values(void)
{
	...
	assert_true(get_piece_value(WQUEEN) 	== 550);
	...
	assert_true(get_piece_value(BQUEEN) 	== 550);
	assert_true(get_piece_value(BKING) 		== 50000);

}

void test_get_colour(void)
{
